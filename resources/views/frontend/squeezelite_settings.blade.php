											...
											<div class="col-md-12 col-sm-12 col-xs-12 edit-input-row padding-all-zero">
												...
												<div class="col-md-6 col-sm-4 col-xs-12 right-input appearance">
													<select class="form-control" name="bitDepth" id="bitDepth">
														...
														<option value="24_3" <?php if($bitDepth == '24_3') { echo "selected"; } ?>>24_3</option>
											...
											<div class="col-md-12 col-sm-12 col-xs-12 edit-input-row padding-all-zero">
												...
												<div class="col-md-6 col-sm-4 col-xs-12 right-input appearance">
													<select class="form-control" name="DSD_NATIVE" id="DSD_NATIVE">
														<option value="disabled" <?php if($DSD_NATIVE == 'disabled') { echo "selected"; } ?>>disabled</option>
														<option value="u8" <?php if($DSD_NATIVE == 'u8') { echo "selected"; } ?>>u8</option>
														<option value="u16le" <?php if($DSD_NATIVE == 'u16le') { echo "selected"; } ?>>u16le</option>
														<option value="u16be" <?php if($DSD_NATIVE == 'u16be') { echo "selected"; } ?>>u16be</option>
														<option value="u32le" <?php if($DSD_NATIVE == 'u32le') { echo "selected"; } ?>>u32le</option>
														<option value="u32be" <?php if($DSD_NATIVE == 'u32be') { echo "selected"; } ?>>u32be</option>
														<option value="dop" <?php if($DSD_NATIVE == 'dop') { echo "selected"; } ?>>dop</option>
													</select>
												</div>
												<div class="col-md-2 col-sm-2 col-xs-12">
													<div class="naoTooltip-wrap">
