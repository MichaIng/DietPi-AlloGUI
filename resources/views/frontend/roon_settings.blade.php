...
<div class="">
	<div class="container">
		...
		<div class="cont">
			...
			<form id = "roon_settings" method="post" action="{{ url('user/changeRoonSettings') }}">
				{{ csrf_field() }}
								...
								<div class="panel panel-default">
									...
									<div id="collapseServicestatus" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="Servicestatus">
										<div class="panel-body">
												...
												<div class="col-md-6 col-sm-4 col-xs-12 right-input">
													<div class="switch">
														<label class="switch-light" onclick="">
															<input type="hidden" name="roonStatus" value="no">
															<input type="checkbox" id="chk" name="roonStatus" value="yes">
																<span>
																	<span>Active</span>
																	<span>Inactive</span>
																</span>
											...
											<div class="col-md-12 col-sm-12 col-xs-12 edit-input-row padding-all-zero">
												<div class="col-md-4 col-sm-6 col-xs-12 left-label">
													<label>Roon Enable / Disable :</label>
												</div>
												<div class="col-md-6 col-sm-4 col-xs-12 right-input">
													<div class="switch">
														<label class="switch-light" onclick="">
															<input type="hidden" class="token" name="_token" value="{{ csrf_token() }}">
															<input type="hidden" name="roon" value="no">
															<input type="checkbox" id="roon" name="roon" value="yes">
															<span>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var roonStatus = "<?php echo $roonStatus ?>";
		var _token = $('.token').val();

		if(roonStatus === 'inactive') {
			$('#chk').prop('checked',true);
			$('#roon').prop('checked',true);
		}
